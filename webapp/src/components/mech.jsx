            ...
            >
                <div className="my-5 mx-2 justify-content-center">
                    <h1 style={{ color: "#6C63FF" }}>
                        <strong>
                            Master's of Science (MS) in Mechanical Engineering
                        </strong>
                    </h1>
                </div>
            </div>
                ...
                <div className="col-7 my-4">
                    ...
                    >
                        ...
                        <p>
                            ...
                            concerned with the manufacturing, designing of
                            mechanisms as well operations of automibiles. It is
                            an introduction to vehicle engineering which deals
                            with motorcycles, cars, buses, trucks etc. It
                            includes elements of mechanical, electronic,
                            software and safety.
                        </p>
                        <p>
                            Mechanical engineering is research-intensive and
                            involves application of mathematical models.
                            Automotive engineers are involved in the design,
                            manufacture, distribution and after-sales care of
                            automobiles which includes cars, motorbikes and
                            other vehicles. Safety engineering and quality
                            management are other aspects of the same branch. It
                            also includes manufacturing of vehicles.
                        </p>
                    </div>
                    <div
                        id="Course Structure"
                    ...
                    >
                        ...
                        <p>
                            The precise structure and content of an automotive
                            engineering program will differ depending on the
                            university you apply to. In some programs you will
                            spend the first one or two years learning the
                            foundations of mechanical engineering, whereas
                            others will focus on automotive topics from the
                            start. Modules you can expect to study include:
                        </p>
                        <p>
                            <ul>
                    ...
                    >
                        ...
                        <h4 style={{}}>
                            <strong>
                                MS in Mech engineering courses offer various
                                specializations.
                            </strong>
                        </h4>
                        <h4 style={{}}>
                        ...
                        <p>
                            <ul>
                                <li>
                                    Automotive Mechatronics and Intelligent
                                    Vehicles
                                </li>
                    ...
                    >
                        ...
                        <p>
                            <ul>
                                <li>
                                    An avid interest in motor vehicle
                                    engineering.
                                </li>
                                <li>
                                    Solid analytical skills and an creative
                                    approach to problem solving.
                                </li>
                                <li>
                                    A thorough understanding of technical
                                    concepts and federal safety standards and
                                    laws.
                                </li>
                                <li>
                    ...
                    >
                        ...
                        <p>
                            The Masters of Mechanical Engineering program
                            requires you to have a previous understanding and
                            knowledge of specific concepts. Listed below are
                        ...
                        <p>
                            ...
                            proof of English proficiency. A Bachelor’s degree in
                            Mechanical Engineering or any other related
                            discipline is also required for MS in Mechanical
                            Engineering.
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <ul>
                            ...
                            <li>
                                New Zealand Aid Programme 2021-2022 Scholarships
                                for international students
                            </li>
                            <li>
                                Australia Awards Scholarships for International
                                Students
                            </li>
                            <li>
                                Global Korea Scholarship - Funded by Korean
                                Government
                            </li>
                            ...
                            <li>
                                Japanese Government (MEXT) Scholarships for
                                Young Leaders Program
                            </li>
                            <li>Heinrich Boll Foundation Scholarships</li>
                            <li>
                                The Frank Wallace Scholarships at University of
                                Bath for Chinese Sudents.
                            </li>
                        </ul>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p>
                            As an automotive engineering graduate you will be
                            well placed for a role in design, manufacturing or
                            testing in the automotive industry. Popular careers
                            with an automotive engineering degree include:
                        </p>
                        <h4 style={{}}>
                            <strong>
