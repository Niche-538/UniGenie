...
const Explore = () => {
    ...
    const getData = () => {
        if (Course == "CS") {
            fetch(
                "http://localhost:8080/getCsUniversityByCountry/" + Country + ""
            )
        ...
        if (Course == "Mech") {
            fetch(
                "http://localhost:8080/getMechUniversityByCountry/" +
                    Country +
                    ""
            )
                .then(function (response) {
        ...
        if (Course == "MBA") {
            fetch(
                "http://localhost:8080/getMbaUniversityByCountry/" +
                    Country +
                    ""
            )
                .then(function (response) {
        ...
        <div>
            ...
            >
                <p>
                    ...
                    All you need to know about university fees, courses,
                    deadlines, scholarships and more.
            ...
            <div
                className="row mx-5 align-items-center text-center justify-content-center rounded border"
                style={{ backgroundColor: "white" }}
            >
                <Table
                    className="my-3 align-items-center text-center justify-content-center"
                    striped
                    bordered
                    hover
                    style={{ width: "800px" }}
